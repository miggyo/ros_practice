...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'pub_num_one = my_first_package.pub_num_one:main',
            'subscribe_num_one = my_first_package.subscribe_num_one:main',
            'pose_subscribe_change_pen = my_first_package.pose_subscribe_change_pen:main',
        ],
    },
)
